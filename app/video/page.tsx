      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
          ...
          <CardContent className="p-0">
            <div className="relative bg-gradient-to-br from-pink-100 via-purple-100 to-yellow-100 aspect-video flex items-center justify-center rounded-t-lg">
              <div className="text-center">
                ...
                <p className="text-xl text-gray-600 mb-6 max-w-2xl"> </p>
                {showPlayer ? (
                  <video
                    key={currentVideo}
                  ...
                  <Button
                    className="bg-purple-500 hover:bg-purple-600 text-white px-8 py-3 rounded-full text-lg"
                    onClick={handlePlay}
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          >
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600">
                Every frame crafted with care and affection just for you
              </p>
            </CardContent>
          </Card>
          ...
          >
            <CardContent className="p-8 text-center">
              <Star
                className="mx-auto text-yellow-500 mb-4 animate-sparkle"
                size={48}
              />
              <h4 className="text-xl font-bold text-purple-600 mb-3">
                Special Moments
              ...
              <p className="text-gray-600">
                Capturing the essence of what makes you extraordinary
              </p>
            </CardContent>
          </Card>
