  ...
  return (
    <div className="min-h-screen pt-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        {/* Welcome Message */}
        <Card
          className={`max-w-4xl mx-auto mb-16 glass-effect border-2 border-pink-200 ${showContent ? "animate-slide-up" : "opacity-0"}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <Link href="/gallery">
            <Card
              className={`card-hover glass-effect border-2 border-pink-200 h-full ${showContent ? "animate-slide-up" : "opacity-0"}`}
              style={{ animationDelay: "0.6s" }}
            >
              <CardContent className="p-8 text-center h-full flex flex-col justify-center">
                <div className="text-6xl mb-4">📸</div>
                <h4 className="text-2xl font-bold text-purple-600 mb-4">Photo Gallery</h4>
                <p className="text-gray-600 mb-4">Beautiful memories captured in time</p>
          ...
          <Link href="/video">
            <Card
              className={`card-hover glass-effect border-2 border-purple-200 h-full ${showContent ? "animate-slide-up" : "opacity-0"}`}
              style={{ animationDelay: "0.8s" }}
            >
              <CardContent className="p-8 text-center h-full flex flex-col justify-center">
                <div className="text-6xl mb-4">🎬</div>
                <h4 className="text-2xl font-bold text-purple-600 mb-4">Special Video</h4>
                <p className="text-gray-600 mb-4">A heartfelt message just for you</p>
          ...
          <Link href="/memories">
            <Card
              className={`card-hover glass-effect border-2 border-yellow-200 h-full ${showContent ? "animate-slide-up" : "opacity-0"}`}
              style={{ animationDelay: "1s" }}
            >
              <CardContent className="p-8 text-center h-full flex flex-col justify-center">
                <div className="text-6xl mb-4">💝</div>
                <h4 className="text-2xl font-bold text-purple-600 mb-4">Sweet Memories</h4>
                <p className="text-gray-600 mb-4">Stories and wishes from the heart</p>
        ...
        <Card
          className={`max-w-2xl mx-auto glass-effect border-2 border-pink-300 ${showContent ? "animate-slide-up" : "opacity-0"}`}
        ...
        >
          <CardContent className="p-8 text-center bg-gradient-animated">
            ...
            <h4 className="text-3xl font-bold text-white mb-4">Another Year of Awesome!</h4>
